...
BPred::~BPred()
{
	...
	if(all[i]>=10 && all[i]<=99){
	    cnt2+=all[i];
	    correct2+=correct[i];
	    inst2++;
	}
	if(all[i]>=100 && all[i]<=999){
	    cnt3+=all[i];
	    correct3+=correct[i];
	    inst3++;
	}
    ...
    std::cout << "1-9     Count: " << cnt1 <<"   Correct: " << correct1 << "     Accuracy:" << double(correct1)/double(cnt1) << "  Inst Number:" << inst1 << std::endl;
    std::cout << "10-99   Count: " << cnt2 <<"   Correct: " << correct2 <<"    Accuracy:" << double(correct2)/double(cnt2) << "  Inst Number:" << inst2<< std::endl;
    std::cout << "100-999 Count: " << cnt3 <<"   Correct: " << correct3 <<"    Accuracy:" << double(correct3)/double(cnt3) << "  Inst Number:" << inst3<< std::endl;
    std::cout << "1000+   Count: " << cnt4 <<"   Correct: " << correct4 << "    Accuracy:" << double(correct4)/double(cnt4) <<"  Inst Number:" << inst4<< std::endl;
